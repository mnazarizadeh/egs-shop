...
public class ExceptionMessages {
    ...
    public static final String RATE_NOT_FOUND = "Requested rating not found!";
    public static final String RATE_ALREADY_EXISTS = "You have already rated this product";
    public static final String RATE_ACCESS_DENIED = "You don't have access to this rating";
}
